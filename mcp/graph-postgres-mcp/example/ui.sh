...
PORT="${UI_PORT:-4000}"
URL="http://${HOST}:${PORT}"
PG_CONTAINER="${PG_CONTAINER_NAME:-graphmcp-example-postgres}"
PG_USER_VALUE="${PG_USER:-exampleuser}"
PG_DATABASE_VALUE="${PG_DATABASE:-exampledb}"
...
PG_HOST="${PG_HOST:-localhost}" PG_PORT="${PG_PORT:-5433}" PG_USER="${PG_USER:-exampleuser}" PG_PASSWORD="${PG_PASSWORD:-examplepass}" PG_DATABASE="${PG_DATABASE:-exampledb}" \
node "$TMP_JS" &
SERVER_PID=$!
