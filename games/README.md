...
3. **Air Board** — A browser whiteboard you draw on with your bare hands, no pen and no mouse, the webcam is the input.
   [pocs/dashboard-cv](https://github.com/diegopacheco/ai-playground/tree/main/pocs/dashboard-cv)

4. **Puppet Shadows** — Hand-shadow puppet recognition with OpenCV contour matching: make a shadow puppet and it names the animal in real time.
   [pocs/fable5-puppet-shadows-cv](https://github.com/diegopacheco/ai-playground/tree/main/pocs/fable5-puppet-shadows-cv)

5. **Sound Guesser** — Make a sound into your microphone (a clap, a knock, a whistle) and the AI guesses what it is, live, fully in the browser.
   [pocs/sound-to-guess-cv](https://github.com/diegopacheco/ai-playground/tree/main/pocs/sound-to-guess-cv)

6. **Jurassic Runner** — An endless runner set in an old jungle of the Jurassic age, with no keyboard — played with the webcam.
   [pocs/jurassic-runner-game](https://github.com/diegopacheco/ai-playground/tree/main/pocs/jurassic-runner-game)

7. **Open Can Enduro** — A tiny browser racer in the spirit of Atari's Enduro, with no keyboard — played with the webcam.
   [pocs/open-can-enduro-game](https://github.com/diegopacheco/ai-playground/tree/main/pocs/open-can-enduro-game)

## AI Agent Games

8. **Terminator vs Mosquitos** — An AI-powered grid simulation where a Terminator hunts mosquitos on a 20x20 battlefield, each side controlled by a chosen agent.
   [pocs/agent-terminator-game](https://github.com/diegopacheco/ai-playground/tree/main/pocs/agent-terminator-game)

9. **Werewolf** — A multi-agent social deduction game where AI agents play Werewolf.
   [pocs/agent-werewolf](https://github.com/diegopacheco/ai-playground/tree/main/pocs/agent-werewolf)

10. **Auction House** — A multi-agent auction where Claude, Gemini, Copilot and Codex bid strategically to become the Savviest Bidder.
    [pocs/agents-auction-hourse](https://github.com/diegopacheco/ai-playground/tree/main/pocs/agents-auction-hourse)

11. **AI Guessing Game** — You think of something and the AI reads your mind; the only words you may say back are HOT and COLD.
    [pocs/ai-guessing-game](https://github.com/diegopacheco/ai-playground/tree/main/pocs/ai-guessing-game)

12. **AI RPG** — A text-based RPG where an LLM acts as the Dungeon Master, generating the world and responding to player actions in real time.
...
17. **Top Speed GP** — A Top Gear-style pseudo-3D arcade racer over a sunset circuit with 19 rivals, nitro boosts and a CRT bezel, one HTML file.
    [pocs/fable5-poc](https://github.com/diegopacheco/ai-playground/tree/main/pocs/fable5-poc)

18. **3D Tetris** — A playable Blockout-style 3D Tetris where polycubes fall down a pit and you slide and rotate them across all three axes.
    [pocs/claude-opus-4.8-poc](https://github.com/diegopacheco/ai-playground/tree/main/pocs/claude-opus-4.8-poc)

19. **Fight Game** — A 2-player cartoon fighting game in the browser, pure HTML5 canvas, drain the other player's health before the timer runs out.
    [pocs/fable-5-fight-game](https://github.com/diegopacheco/ai-playground/tree/main/pocs/fable-5-fight-game)

20. **Bomberman-like** — A Bomberman-style arcade game on a canvas: drop bombs, blast bricks, collect power-ups and clear all four foes.
    [pocs/fable-5-bombermanlike](https://github.com/diegopacheco/ai-playground/tree/main/pocs/fable-5-bombermanlike)

21. **Cyber Jungle DoomLike** — A small browser FPS using classic raycasting for a fast retro corridor-shooter feel.
...
22. **Megaslop Runner** — A cyberpunk endless runner where you are an AI coding agent that runs forever, flinging slop while devs hurl determinism at you.
    [pocs/megaslop-runner](https://github.com/diegopacheco/ai-playground/tree/main/pocs/megaslop-runner)

23. **Mega Slop** — An 8-bit, CRT-flavored platform shooter where you play a green slop-bot.
