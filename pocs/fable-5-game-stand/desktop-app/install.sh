...
/usr/libexec/PlistBuddy -c "Set :CFBundleShortVersionString 1.0.1" "$app_bundle/Contents/Info.plist"
/usr/libexec/PlistBuddy -c "Set :CFBundleVersion 1.0.1" "$app_bundle/Contents/Info.plist"
touch "$app_bundle"
