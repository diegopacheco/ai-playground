package com.github.diegopacheco.devadminconsole.registry;
...
public class ConnectionRegistry {
    ...
    private AutoCloseable buildJdbc(ConnectionConfig config) {
        ...
        hikari.setPoolName("dev-admin-console-" + config.id());
        if (config.kind() == com.github.diegopacheco.devadminconsole.project.ConnectionKind.POSTGRES) {
    ...
    private AutoCloseable buildKafka(ConnectionConfig config) {
        ...
        properties.put(AdminClientConfig.CLIENT_ID_CONFIG, "dev-admin-console-" + config.id());
