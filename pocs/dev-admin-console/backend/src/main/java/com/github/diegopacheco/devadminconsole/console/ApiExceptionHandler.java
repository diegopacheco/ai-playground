...
public class ApiExceptionHandler {
    @ExceptionHandler(com.github.diegopacheco.devadminconsole.engine.ReadOnlyViolation.class)
    public ResponseEntity<Map<String, Object>> readOnly(
            com.github.diegopacheco.devadminconsole.engine.ReadOnlyViolation error) {
